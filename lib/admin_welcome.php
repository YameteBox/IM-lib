...
<body>
    <div class="card">
        ...
        <h1>You're logged in, Admin #<?= htmlspecialchars($_SESSION['username']) ?>!</h1>
        ...
        <div class="links-row">
            <a class="logout" href="admin_library.php">Browse the library</a>
            <a class="logout" href="admin_register.php">Log out</a>
        </div>
    </div>
</body>
</html>
